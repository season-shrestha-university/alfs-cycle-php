...
<body>
  ...
  <main id="main-content" tabindex="-1">
    <!-- Hero section -->
    <section class="hero">
      <h1>Keeping <em>Cheriton</em> cycling for generations</h1>
      <!-- Cycle illustration -->
      <svg role="img" aria-label="Cycle illustration" id="cycle-illustration" width="370" height="218" viewBox="0 0 370 218" fill="none"
      ...
      <figure>
        <img loading="lazy" decoding="async" width="168" height="126" src="./assets/images/alfs/alf-in-store.webp" alt="Alf's Cycle workshop in 1983">
        ...
        <svg role="img" aria-label="40 years of service" id="service-40-years" viewBox="0 0 704 223" fill="none" stroke="white" stroke-width="0.35"
          xmlns="http://www.w3.org/2000/svg">
          <path
    ...
    <section>
      ...
      <div class="articles-grid">
        <article>
          <figure>
            <svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" width="124" height="124" fill="none" viewBox="0 0 124 124">
    ...
    <section class="event">
      ...
      <svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" width="189" height="195" fill="none" viewBox="0 0 189 195">
        <path fill="#8a0303" fill-opacity=".2" d="m0 151 40-58L7 30l67 20 49-50 2 70 63 31-66 24-10 69-43-55z" />
      </svg>
      <figure>
        <img loading="lazy" decoding="async" width="600" height="338" src="./assets/images/events/event-1998.webp" alt="1998 Alf's Cycle Event">
        <figcaption>
          <p>
