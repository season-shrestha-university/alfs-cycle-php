...
<header>
  ...
  <nav aria-label="Main">
    ...
    <a href="<?php echo isset($base_url) ? $base_url : './'; ?>index.php" aria-label="Alf's Cycle homepage">
      <svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" width="85" height="46" fill="none"
        viewBox="0 0 85 46">
        <path fill="#000"
    ...
    <div class="header-contact">
      ...
      <output aria-live="polite" id="status"
        class="<?php echo $is_closed ? 'closed' : 'open'; ?>"><?php echo htmlspecialchars($store_status); ?></output>
