<header>
  ...
  <nav aria-label="Main">
    ...
    <a href="<?php echo isset($base_url) ? $base_url : './'; ?>index.php" aria-label="Alf's Cycle homepage">
      <svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" width="85" height="46" fill="none" viewBox="0 0 85 46">
        <path fill="#000"
    ...
    <div class="header-contact">
      ...
      <a href="tel:+447484000000" aria-label="Call Alf's Cycle workshop">
        <svg aria-hidden="true" focusable="false" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
          <path fill="#000"
