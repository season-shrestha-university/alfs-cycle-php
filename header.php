<header>
  <nav aria-label="Main">
    <!-- Logo -->
    <a href="./index.php" aria-label="Alf's Cycle homepage">
    ...
    <ul id="main-menu" role="menu">
      ...
      <li role="none">
        <a href="./bikes.php" role="menuitem">Bikes</a>
      </li>
      <li role="none">
        <a href="./accessories.php" role="menuitem">Accessories</a>
      </li>
      <li role="none">
        <a href="./event.php" role="menuitem">Events</a>
      </li>
      <li role="none">
        <a href="./about.php" role="menuitem">About</a>
      </li>
      <li role="none">
